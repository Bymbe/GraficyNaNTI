                    ...
                    if (comment.data.Edited === true) {
                        return (
                            <li key={comment.id}>
                                ...
                                <p className={Style.Nick} style={stylCiemne(sizeFlag, colorFlag)}  >{comment.data.Nickname}</p>
                                <p className={Style.Comment} style={stylJasne(sizeFlag, colorFlag)}  >Question: {comment.data.Question}</p>
                                <p className={Style.Answer} style={stylCiemne(sizeFlag, colorFlag)}  > Answer: {comment.data.Answer}</p>
                            </li>
                        )
                    } else {
                        return (
